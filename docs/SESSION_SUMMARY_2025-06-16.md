...
When a user reports the same issue multiple times, STOP making assumptions and dig deeper. Use systematic debugging and leverage tools like mcp**zen**thinkdeep for complex analysis.
