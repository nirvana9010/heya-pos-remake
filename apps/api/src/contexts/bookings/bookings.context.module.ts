...
import { StaffBlocksV2Controller } from "./infrastructure/controllers/staff-blocks.v2.controller";
...
@Module({
  ...
  controllers: [BookingsV2Controller, StaffBlocksV2Controller],
  providers: [
    // Repository
    {
