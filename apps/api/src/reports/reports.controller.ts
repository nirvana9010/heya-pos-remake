...
export class ReportsController {
  ...
  @Get('revenue')
  async getRevenueStats(@Request() req: any, @Query('locationId') locationId?: string) {
    const merchantId = req.user.merchantId;
    return this.reportsService.getRevenueStats(merchantId, locationId);
  }

  @Get('bookings')
  async getBookingStats(@Request() req: any, @Query('locationId') locationId?: string) {
    const merchantId = req.user.merchantId;
  ...
  @Get('overview')
  async getOverview(@Request() req: any, @Query('locationId') locationId?: string) {
    const merchantId = req.user.merchantId;
