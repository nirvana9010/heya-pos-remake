...
describe("SmsService", () => {
  ...
  describe("sendNotification", () => {
    ...
    it("should successfully send a BOOKING_CONFIRMATION SMS", async () => {
      ...
      const mockMessage =
        "Hi Jane, your booking BK-001 is confirmed for 20/01 at 2:00 PM. See you at Test Salon!";

      (templateService.renderSmsTemplate as jest.Mock).mockResolvedValue(
        mockMessage,
      );

      const result = await service.sendNotification(type, mockContext);

      expect(templateService.renderSmsTemplate).toHaveBeenCalledWith(
        type,
        mockContext,
      );
    ...
    it("should successfully send a BOOKING_REMINDER_24H SMS", async () => {
      ...
      const mockMessage =
        "Hi Jane, reminder: Your appointment at Test Salon is tomorrow at 2:00 PM. Reply CANCEL to cancel.";
    ...
    it("should successfully send a BOOKING_REMINDER_2H SMS", async () => {
      ...
      const mockMessage =
        "Hi Jane, your appointment at Test Salon is in 2 hours (2:00 PM). We look forward to seeing you!";
    ...
    it("should successfully send a BOOKING_CANCELLED SMS", async () => {
      ...
      const mockMessage =
        "Hi Jane, your booking BK-001 at Test Salon has been cancelled. Call 0412345678 to rebook.";
    ...
    it("should successfully send a BOOKING_RESCHEDULED SMS", async () => {
      ...
      const mockMessage =
        "Hi Jane, your booking at Test Salon has been rescheduled to 21/01 at 3:00 PM.";
    ...
    it("should handle template rendering failure", async () => {
      ...
      (templateService.renderSmsTemplate as jest.Mock).mockRejectedValue(
        renderError,
      );
    ...
    it("should handle SMS provider send failure", async () => {
      ...
      (mockProvider.sendMessage as jest.Mock).mockRejectedValue(
