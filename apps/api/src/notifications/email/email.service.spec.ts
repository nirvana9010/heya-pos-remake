...
describeEmailService("EmailService", () => {
  ...
  describe("sendNotification", () => {
    ...
    it("should successfully send a BOOKING_CONFIRMATION email", async () => {
      ...
      (templateService.renderEmailTemplate as jest.Mock).mockResolvedValue(
        mockTemplate,
      );
    ...
    it("should handle template rendering failure", async () => {
      ...
      (templateService.renderEmailTemplate as jest.Mock).mockRejectedValue(
        renderError,
      );
