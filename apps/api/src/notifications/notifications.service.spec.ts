...
const describeNotificationsService =
  process.env.ENABLE_LEGACY_NOTIFICATIONS_TESTS === "true"
    ? describe
    : describe.skip;
...
describeNotificationsService("NotificationsService", () => {
  ...
  describe("sendBookingNotification", () => {
    ...
    it("should handle booking not found", async () => {
      ...
      await expect(
        service.sendBookingNotification(
          "non-existent",
    ...
    it("should handle missing customer data", async () => {
      ...
      (bookingRepository.findOne as jest.Mock).mockResolvedValue(
  ...
  describe("logging", () => {
    ...
    it("should log errors when notifications fail", async () => {
      ...
      (bookingRepository.findOne as jest.Mock).mockRejectedValue(
        new Error("Database error"),
      );
