...
type MerchantContentConfig = {
  ...
  testimonials?: MerchantTestimonial[];
  address?: string;
  phone?: string;
  email?: string;
};
...
const merchantContent: Record<string, MerchantContentConfig> = {
  default: {
    hero: {
      title: "Welcome to Heya POS Merchant",
      subtitle:
        "Experience tailored treatments designed to help you look and feel your best.",
  ...
  hamilton: {
    hero: {
      ...
      subtitle:
        "Sydney's premier beauty destination offering cutting-edge treatments and personalized care.",
    ...
    testimonials: [
      {
        ...
        name: "Jessica M.",
        rating: 5,
        text: "The best beauty spa in Sydney! Their attention to detail is unmatched.",
      },
      {
        id: "2",
        name: "Amanda L.",
        rating: 5,
        text: "I've been coming here for years. Consistently excellent service!",
      },
      {
        id: "3",
        name: "Sophie R.",
        rating: 5,
        text: "The staff is incredible and the results speak for themselves.",
      },
    ],
  ...
  "zen-wellness": {
    hero: {
      ...
      subtitle:
        "Holistic wellness treatments that rejuvenate your body, mind, and soul in Melbourne's tranquil oasis.",
    ...
    testimonials: [
      {
        ...
        name: "David K.",
        rating: 5,
        text: "The most relaxing experience I've ever had. Truly transformative!",
      },
      {
        id: "2",
        name: "Maria G.",
        rating: 5,
        text: "Their holistic approach to wellness is exactly what I needed.",
      },
      {
        id: "3",
        name: "Tom H.",
        rating: 5,
        text: "I leave feeling refreshed and renewed every single time.",
      },
    ],
  ...
  return (
    <MerchantGuard>
      <main className="min-h-screen">
        {/* Hero Section */}
        <section
          className={`relative bg-gradient-to-br ${content.hero.gradient} text-white`}
        >
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground">
                    {loading ? (
                      ...
                      <>
                        {isDayOpen(businessHours.monday) &&
                        isDayOpen(businessHours.friday) &&
                        businessHours.monday?.open ===
                          businessHours.tuesday?.open &&
                        businessHours.monday?.open ===
                          businessHours.wednesday?.open &&
                        businessHours.monday?.open ===
                          businessHours.thursday?.open &&
                        businessHours.monday?.open ===
                          businessHours.friday?.open &&
                        businessHours.monday?.close ===
                          businessHours.tuesday?.close &&
                        businessHours.monday?.close ===
                          businessHours.wednesday?.close &&
                        businessHours.monday?.close ===
                          businessHours.thursday?.close &&
                        businessHours.monday?.close ===
                          businessHours.friday?.close ? (
                          <>
                            Mon - Fri: {formatTime(businessHours.monday?.open)}{" "}
                            - {formatTime(businessHours.monday?.close)}
                            <br />
                          </>
                        ) : (
                          <>
                            Mon - Fri: Various hours
                            <br />
                          </>
                        )}
                        {isDayOpen(businessHours.saturday) &&
                        isDayOpen(businessHours.sunday) &&
                        businessHours.saturday?.open ===
                          businessHours.sunday?.open &&
                        businessHours.saturday?.close ===
                          businessHours.sunday?.close ? (
                          <>
                            Sat - Sun:{" "}
                            {formatTime(businessHours.saturday?.open)} -{" "}
                            {formatTime(businessHours.saturday?.close)}
                          </>
                        ) : (
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground">
                    {merchant?.phone || "No phone available"}
                    <br />
          ...
          <section className="py-16 bg-secondary/30">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground">
                  {isZen
                    ? "Hear from our wellness community"
