...
const values = [
  {
    ...
    title: "Excellence",
    description:
      "We strive for excellence in every service we provide, using only the best products and techniques.",
  },
  {
    icon: Users,
    title: "Community",
    description:
      "Building lasting relationships with our clients and being a positive part of our local community.",
  },
  {
    icon: Heart,
    title: "Passion",
    description:
      "Our team is passionate about beauty and wellness, dedicated to helping you look and feel your best.",
  },
  {
    icon: Sparkles,
    title: "Innovation",
    description:
      "Staying ahead with the latest trends and techniques in the beauty industry.",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    {merchant?.name} began with a simple vision: to create a
                    welcoming space where clients could relax, rejuvenate, and
                    leave feeling their absolute best.
                  </p>
                  <p>
                    Our {isZen ? "wellness center" : "salon"} has grown from
                    humble beginnings to a full-service{" "}
                    {isZen ? "wellness" : "beauty"} destination. Throughout our
                    journey, we&apos;ve remained true to our core values of
                    quality, personalization, and exceptional customer service.
                  </p>
                  <p>
                    Today, {merchant?.name} is home to a team of talented
                    professionals who share our commitment to excellence. We
                    continue to evolve with the industry, embracing new
                    techniques and technologies while maintaining the personal
                    touch that our clients love.
                  </p>
                </div>
              </div>
