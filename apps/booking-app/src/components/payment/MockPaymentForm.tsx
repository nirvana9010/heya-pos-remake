  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message === "timeout") {
        setError(
          "Payment processing timed out. Please check with your bank or try again.",
        );
        ...
        if (cardNumber !== VALID_TEST_CARD.cardNumber) {
          ...
          if (cleanNumber.startsWith("4000")) {
            ...
            setError(
              "Transaction limit exceeded. Please try a smaller amount or contact your bank.",
            );
          } else {
            setError(
          ...
          setError(
            "Invalid security code. Please check the 3-digit code on the back of your card.",
          );
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <p className="text-sm text-yellow-800">
                <strong>Test Mode:</strong> This is a mock payment form. No real
            ...
            <div className="mt-4 pt-4 border-t border-yellow-300">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <code className="bg-yellow-100 px-2 py-0.5 rounded font-mono">
                    Any card with wrong expiry
                  </code>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-yellow-800">Invalid CVV:</span>
                  <code className="bg-yellow-100 px-2 py-0.5 rounded font-mono">
                    Any card with wrong CVV
                  </code>
                </div>
              </div>
            </div>
