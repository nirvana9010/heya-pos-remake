    ...
    <div style={{ padding: "20px", fontFamily: "monospace" }}>
      ...
      <div style={{ margin: "20px 0", padding: "20px", background: "#f0f0f0" }}>
        <p>
          ...
          {apiUrl || "NOT SET (undefined)"}
        </p>
        <p>
          <strong>Default would be:</strong> http://100.107.58.75:3000
        </p>
        <p>
      ...
      {!apiUrl && (
        <div style={{ color: "red" }}>
          ...
          <p>
            This means all API calls will go to http://100.107.58.75:3000 which
            won't work in production.
          </p>
          <p>
            You need to add this environment variable in Vercel's project
