...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        err?.code !== "AUTH_IN_PROGRESS" &&
        err?.message !== "UNAUTHORIZED_REDIRECT"
      ) {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                className="self-end text-sm text-teal-600 hover:text-teal-700 sm:self-auto"
              >
                Forgot password?
              </a>
            </div>
              ...
              <div className="mt-6 space-y-3">
                <div className="text-center text-sm text-gray-600 break-words">
                  ...
                  <div className="space-y-1">
                    <div>
                      <strong>Hamilton Beauty:</strong> Email:{" "}
                    ...
                    <div>
                      <strong>Zen Wellness:</strong> Email:{" "}
                      <code className="bg-gray-100 px-1 py-0.5 rounded break-all">
                        lukas.tn90@gmail.com
                      </code>
                      , Password:{" "}
                      <code className="bg-gray-100 px-1 py-0.5 rounded">
                        demo456
