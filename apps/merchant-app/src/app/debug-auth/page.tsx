        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <div className="bg-gray-100 p-3 rounded space-y-1 text-sm">
              <div>
                Has Auth Cookie: {debugInfo.hasAuthCookie ? "✅ Yes" : "❌ No"}
              </div>
              <div>
              ...
              >
                State Mismatch:{" "}
                {debugInfo.mismatch
                  ? "⚠️ YES - This causes redirect loops!"
                  : "✅ No"}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-blue-50 p-3 rounded text-sm space-y-2">
              <p>
                <strong>When you visit /login:</strong>
              </p>
              ...
              <p className="mt-3">
                <strong>When you visit /calendar:</strong>
              </p>
              <ol className="list-decimal ml-5 space-y-1">
                <li>Page wrapped in AuthGuard (client-side)</li>
                <li>AuthGuard checks localStorage for access_token</li>
                <li>
                  If no token → shows "Redirecting to login..." → redirects to
                  /login
                </li>
                <li>
                  Creates infinite loop if cookie exists but localStorage
                  doesn't
                </li>
              </ol>
            </div>
