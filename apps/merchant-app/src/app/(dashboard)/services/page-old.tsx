...
export default function ServicesPage() {
  ...
  const stats = useMemo(() => {
    ...
    const avgPrice =
      activeServices.length > 0 ? totalPrice / activeServices.length : 0;
  ...
  const filteredServicesByCategory = useMemo(() => {
    ...
    Object.entries(servicesByCategory).forEach(
  ...
  const handleBulkPriceUpdate = async () => {
    ...
    try {
      const updates = selectedServices.map(async (serviceId) => {
        ...
        return apiClient.updateService(serviceId, {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container max-w-7xl mx-auto p-6 space-y-6">
        ...
        {showSuccessBanner && (
          <div
            className={`transform transition-all duration-500 ${showSuccessBanner ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`}
          >
          ...
          {Object.entries(filteredServicesByCategory).map(
            ([categoryName, categoryServices]) => {
              ...
              const categoryStats = {
                ...
                totalPrice: categoryServices.reduce(
                  (sum, s) => sum + s.price,
                  0,
                ),
                avgPrice:
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isNewCategory
                      ? "border-green-400 ring-2 ring-green-100 animate-pulse-once"
                      : "border-gray-200",
                  )}
                >
                  {/* Category Header */}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {categoryStats.active} active • Avg $
                      ...
                      {categoryServices.length === 0 ? (
                        <div className="p-8 text-center">
                          ...
                          <p className="text-sm text-gray-600 mb-4">
                            Start by adding services to organize your service
                            menu.
                          </p>
                          <Button
                            onClick={() => {
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-start gap-4">
                                  ...
                                  <div
                                    className={cn(
                                      "h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0 text-lg font-bold",
                                      colors.light,
                                      colors.border,
                                      "border",
                                    )}
            ...
            <div className="space-y-8 pb-20">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Use arrow keys or type (5-240 mins)
                    </p>
                  </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-5">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    These notes will be visible to staff when viewing this
                    service
                  </p>
                </div>
              </div>
      ...
      >
        <div className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              This will {priceAdjustment.value >= 0 ? "increase" : "decrease"}{" "}
              the selected service prices by{" "}
              {priceAdjustment.type === "percentage"
            ...
            services.find((s) => s.id === deletingServiceId) && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-600">
                    ${services.find((s) => s.id === deletingServiceId)?.price} •{" "}
                    {services.find((s) => s.id === deletingServiceId)?.duration}{" "}
                    min
                  </p>
                </div>
              </div>
      ...
      <CategoryDialog
        ...
        onSuccess={async (categoryData) => {
          ...
          if (!editingCategory) {
            ...
            setSuccessMessage(
              `Category "${categoryData.name}" created successfully! You can now assign services to this category.`,
            );
