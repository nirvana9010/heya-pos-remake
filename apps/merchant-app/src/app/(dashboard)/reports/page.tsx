...
function ActivityLogTab() {
  ...
  const handleExportCSV = useCallback(() => {
    if (!activityData?.data?.length) {
      toast({
        title: "No data",
        description: "No activity log entries to export",
        variant: "destructive",
      });
      return;
    }
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-end">
            ...
            <div className="flex-1 min-w-[160px]">
              ...
              <Select
                ...
                onValueChange={handleFilterChange(setStaffFilter)}
              >
                <SelectTrigger>
...
export default function ReportsPage() {
  ...
  const [viewMode, setViewMode] = useState<"executive" | "classic">(
    "executive",
  );
  ...
  const OverviewTab = () => {
    ...
    const bookingGrowth =
      reportData.bookingGrowth?.[
        timeRange as keyof typeof reportData.bookingGrowth
      ] || 0;
    ...
    const avgBookingValue =
      reportData.avgBookingValue ||
      (monthlyBookings > 0 ? monthlyRevenue / monthlyBookings : 0);
    ...
    const revenueTrendArray = Array.isArray(reportData.revenueTrend)
      ? reportData.revenueTrend
      : [];
    const sparklineData = revenueTrendArray
      .slice(-12)
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  ...
                  {timeRange === "weekly" &&
                    "Weekly revenue over the last 8 weeks"}
                  {timeRange === "monthly" &&
                    "Monthly revenue over the last 6 months"}
                  {timeRange === "yearly" &&
                    "Yearly revenue over the last 5 years"}
                </CardDescription>
              </div>
              <Button
                variant="outline"
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Utilization and revenue by staff member
              </CardDescription>
            </CardHeader>
            <CardContent>
