...
export default function CustomerProfilePage() {
  ...
  const isVIP =
    (customer.totalSpent || 0) > 1000 || (customer.totalVisits || 0) > 10;
  const memberSince = formatDistanceToNow(parseISO(customer.createdAt), {
    addSuffix: true,
  });
  ...
  const averageSpend = customer.totalVisits
    ? (customer.totalSpent || 0) / customer.totalVisits
    : 0;

  // Get favorite services
  const serviceFrequency = completedBookings.reduce(
    (acc, booking) => {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Customer #{customer.id.slice(-6).toUpperCase()}
                  </p>
                </div>
              </div>
            </div>
                            ...
                            <div>
                              ...
                              <div className="text-sm">
                                <p className="font-medium text-blue-800">
                                  {upcomingBookings[0].serviceName}
                                </p>
                                ...
                                <p className="text-blue-700">
                                  with {upcomingBookings[0].staffName}
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="space-y-3">
                          ...
                          >
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {format(
                                  parseISO(booking.startTime || booking.date),
                                  "MMM d, yyyy",
                                )}{" "}
                                • {booking.staffName}
                              </p>
                        ...
                        {completedBookings.length > 10 && (
                          <p className="text-center text-sm text-gray-500 pt-2">
                            Showing latest 10 visits of{" "}
                            {completedBookings.length} total
                          </p>
                        )}
                      </div>
                    )}
