  ...
  const loadSchedule = async () => {
    try {
      ...
      toast({
        title: "Error",
        description:
          error.response?.data?.message || "Failed to load staff schedule",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="space-y-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          Leave a day empty if the staff member doesn't work that day. If no
          schedule is set, the business hours will be used as the default.
        </AlertDescription>
      </Alert>
