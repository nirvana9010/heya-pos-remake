...
export function CustomerDetailsDialog({
  ...
  const handleSave = async () => {
    try {
      ...
      const updateResult = await apiClient.updateCustomer(
        customer.id,
        updateData,
      );
      ...
      if (loyaltyChanged) {
        ...
        console.log(
          "Adjusting loyalty for customer:",
          customer.id,
          adjustmentData,
        );
        ...
        try {
          const loyaltyResult = await apiClient.loyalty.adjustLoyalty(
            customer.id,
            adjustmentData,
          );
          ...
          toast({
            ...
            description:
              "Customer info updated but loyalty adjustment failed. Please try again.",
            variant: "destructive",
          });
          onUpdate?.();
          return;
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setLoyaltyData({
                            ...loyaltyData,
                            loyaltyVisits: parseInt(e.target.value) || 0,
                          })
                        }
                        className="flex-1"
                      />
                    ...
                    <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                      ...
                      <span className="font-medium">
                        {customer.loyaltyVisits || 0} visits
                      </span>
                    </div>
                  )}
                </div>
