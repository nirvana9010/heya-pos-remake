  ...
  useEffect(() => {
    ...
    try {
      ...
      if (
        merchantData &&
        userData &&
        JSON.stringify(merchantData) === JSON.stringify(userData)
      ) {
        console.log(
          "[ClearCorruptedAuth] Detected corrupted auth data, clearing...",
        );
      ...
      console.log(
        "[ClearCorruptedAuth] Failed to parse auth data, clearing...",
      );
      localStorage.clear();
      sessionStorage.clear();
      window.location.href = "/login";
