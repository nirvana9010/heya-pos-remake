              ...
              {program.type === "VISITS" ? (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-600">
                    {program.visitsRequired - (loyalty?.currentVisits || 0)}{" "}
                    more visits until reward
                  </p>
                </div>
              ) : (
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium">
                      $
                      {(
                        (loyalty?.currentPoints || 0) * program.pointsValue
                      ).toFixed(2)}
                    </span>
                  </div>
                </div>
                  ...
                  {program.type === "VISITS" ? (
                    <>
                      ...
                      <Button
                        ...
                        onClick={() => handleAdjustment("visits", -1)}
                        disabled={
                          processing || (loyalty?.currentVisits || 0) === 0
                        }
                      >
                        -1 Visit
                      </Button>
                    ...
                    <>
                      ...
                      <Button
                        ...
                        onClick={() => handleAdjustment("points", -50)}
                        disabled={
                          processing || (loyalty?.currentPoints || 0) < 50
                        }
                      >
                        -50 Points
                      </Button>
