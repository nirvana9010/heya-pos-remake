...
export function SetupOwnerPin({ onComplete, mode }: SetupOwnerPinProps) {
  ...
  const handleCreateOwner = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          error.response?.data?.message || "Failed to create owner account",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const ownerName =
    typeof window !== "undefined" ? localStorage.getItem("owner_name") : null;
          ...
          <form onSubmit={handleSetPin} className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                reports, process refunds, and perform other sensitive
                operations. Keep it secure and do not share it.
              </AlertDescription>
            </Alert>
