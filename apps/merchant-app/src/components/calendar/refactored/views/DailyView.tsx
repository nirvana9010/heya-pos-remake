        ...
        <div className="min-w-[600px]">
          ...
          >
            ...
            {visibleStaff.map((staffMember) => {
              ...
              return (
                <div key={staffMember.id} className="h-16 px-4 flex items-center justify-between border-r border-slate-400/60 last:border-r-0 bg-white">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                    ...
                    return (
                      <DroppableTimeSlot
                        ...
                        className={cn(
                          ...
                          staffIndex < visibleStaff.length - 1 && "border-r border-slate-400/60",
                          (() => {
