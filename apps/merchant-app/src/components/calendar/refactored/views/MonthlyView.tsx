...
export function MonthlyView({ onBookingClick, onDayClick }: MonthlyViewProps) {
  ...
  return (
    <div
      className={cn("flex-1 overflow-auto min-h-0", isMobile ? "p-1" : "p-4")}
    >
      <div className="bg-white rounded-lg shadow-sm border">
        ...
        <div className="grid grid-cols-7">
          {days.map((day) => {
            ...
            const dayBookings =
              bookingsByDate.get(format(day, "yyyy-MM-dd")) || [];
            const isCurrentMonth =
              day.getMonth() === state.currentDate.getMonth();
            ...
            const staffWithBookings = [
              ...new Set(dayBookings.map((b) => b.staffId)),
            ];
                      ...
                      {dayBookings.slice(0, isMobile ? 2 : 3).map((booking) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {(booking.status === "pending" ||
                              booking.status === "PENDING") && (
                              <span className="text-[8px] font-bold bg-yellow-500 text-white px-1 rounded flex-shrink-0">
                                P
                              </span>
                            )}
