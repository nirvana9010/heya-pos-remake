...
const systemAlerts = [
  {
    id: "1",
    type: "warning",
    message: "High server load detected on API cluster 2",
    time: "5 minutes ago",
  },
  {
    id: "2",
    type: "info",
    message: "Scheduled maintenance window: Sunday 2:00 AM - 4:00 AM AEDT",
    time: "1 hour ago",
  },
  {
    id: "3",
    type: "success",
    message: "Payment processing system upgrade completed successfully",
    time: "3 hours ago",
  },
];
  ...
  },
  {
    ...
    cell: ({ row }: any) => (
      <Badge variant="outline">
        {row.original.subscriptionPlan || "basic"}
      </Badge>
    ),
  },
  {
    ...
    cell: ({ row }: any) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => console.log("Edit merchant:", row.original.id)}
          >
            Edit
          </DropdownMenuItem>
          <DropdownMenuItem
  ...
  const loadData = async () => {
    try {
      ...
      const dashboardStats = {
        monthlyRevenue: merchantsData.reduce(
          (sum, m) => sum + Math.random() * 50000,
          0,
        ),
      ...
      setStats({
        ...
        activeMerchants: merchantsData.filter((m) => m.status === "active")
          .length,
    ...
    <main className="container max-w-7xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Monitor and manage the entire Heya POS platform
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          description={
            loading ? "Loading..." : `${stats.activeMerchants} active`
          }
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Newly registered businesses on the platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold">
                {loading ? "-" : stats.activeBookings.toLocaleString()}
              </p>
              <p className="text-sm text-muted-foreground">
