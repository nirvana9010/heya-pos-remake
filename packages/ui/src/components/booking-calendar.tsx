      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <Button
            ...
            size="icon"
            onClick={() =>
              onDateChange(addDays(date, view === "week" ? -7 : -1))
            }
          >
              ...
              <tr>
                ...
                {view === "week"
                  ...
                  : staffSchedules.map((staff) => (
                      <th
                        key={staff.staffId}
                        className="p-2 text-center text-sm font-medium border-b min-w-[150px]"
                      >
                  ...
                  {view === "week"
                    ? weekDays.map((day) => (
                        <React.Fragment key={day.toISOString()}>
                          {staffSchedules.map((staff) => (
                            <td
                              key={`${day.toISOString()}-${staff.staffId}`}
                              className="p-1 border-b border-r h-16"
                            >
