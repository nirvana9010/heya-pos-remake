...
export const mockServices: Service[] = [
  ...
  },
  {
    id: "4",
    name: "Blowdry",
    description: "Professional blowdry",
    duration: 45,
    price: 45,
    categoryId: "1",
    categoryName: "Hair",
...
export const mockStaff: Staff[] = [
  ...
  },
  {
    id: "2",
    name: "James Brown",
    email: "james@hamiltonbeauty.com",
    phone: "555-0102",
    role: "staff",
    isActive: true,
    services: ["5", "6", "7"],
  ...
  },
  {
    id: "4",
    name: "Michael Chen",
    email: "michael@hamiltonbeauty.com",
    phone: "555-0104",
    role: "staff",
    isActive: true,
    services: ["10", "11"],
...
export const mockPayments: Payment[] = [
  ...
  },
  {
    ...
    refundedAmount: 65,
    refundedAt: new Date("2024-01-09"),
  },
];
...
export const mockMerchants: Merchant[] = [
  {
    id: "1",
    merchantCode: "HAMILTON",
    businessName: "Hamilton Beauty Salon",
...
export const mockApi = {
  ...
  async verifyPin(pin: string): Promise<User> {
    ...
    const pinUsers: Record<string, User> = {
      ...
      "9999": {
        id: "3",
        name: "Test Owner",
        email: "owner@hamiltonbeauty.com",
        role: "owner",
        accessLevel: 3,
      },
    };
  ...
  async createService(data: Partial<Service>): Promise<Service> {
    ...
    const newService: Service = {
      ...
      categoryName:
        mockCategories.find((c) => c.id === data.categoryId)?.name || "Other",
