...
FRONTEND_URLS="https://hub.heyapos.com,https://heya-pos-remake-merchant-app.vercel.app,https://visit.heyapos.com,https://booking.heyapos.com,https://heya-pos-remake-admin-dashboard.vercel.app,http://localhost:3001,http://localhost:3002,http://localhost:3003"
